...
#define olly_attach_to_active_process   Attachtoactiveprocess
#define olly_browse_filename            Browsefilename
...
#define olly_find_sorted_data           Findsorteddata
#define olly_find_thread                Findthread
#define olly_get_cpu_thread_id          Getcputhreadid
#define olly_get_long                   Getlong
#define olly_get_hex_string             Gethexstring
...
#define olly_read_memory                Readmemory
