...
function eventHandler() {
    if (percent(demicm.EVENT_MAN_PER)) {
        console.log('id_' + (demicm.evtId + demicm.SPEC_OFFSET) + ' = arguments[0];');
...
function callBackJs() {
    console.log('//callBackJs = function()');
    console.log('/-{');
...
function setCallBack() {
    ...
    for (var i = 1; i < id.length; i++) {
        ...
        id[i].toString = new Function('console.log("//id_' + i 
            + '.toString = function()");console.log("/-{");callBack();');
        id[i].toLocalString = new Function('console.log("//id_' + i 
            + '.toLocalString = function()");console.log("/-{");callBack();');
        id[i].valueOf = new Function('console.log("//id_' + i 
            + '.valueOf = function()");console.log("/-{");callBack();');
    }
}
...
function appendForm(rId, rTxt) {
    ...
    console.log('id_' + (id.length - 1) + '.min = 20;');
    id[id.length - 1].min = 20;
    console.log('id_' + (id.length - 1) + '.max = 120;');
    id[id.length - 1].max = 120;
    console.log('id_' + (id.length - 1) + '.step = 5;');
    id[id.length - 1].step = 5;
    console.log('id_' + (id.length - 1) + '.value = 50;');
    ...
    console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
    id[id.length - 1].id = id.length - 1;
    console.log('id_' + (id.length - 1) + '.type = "email";');
    ...
    console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
    id[id.length - 1].id = id.length - 1;
    console.log('id_' + (id.length - 1) + '.type = "url";');
    ...
    console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
    id[id.length - 1].id = id.length - 1;
    console.log('id_' + (id.length - 1) + '.type = "search";');
    ...
    if (demicm.BROWSER == 'CM' || demicm.BROWSER == 'FF') {
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "color";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "datetime";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "datetime-local";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "time";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "date";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "week";');
        ...
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
        console.log('id_' + (id.length - 1) + '.type = "month";');
    ...
    console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
    id[id.length - 1].id = id.length - 1;
    console.log('id_' + (id.length - 1) + '.type = "tel";');
...
function appendCanvas2D(rId, rTxt) {
    ...
    console.log('id_' + (demicm.canvas2dId + demicm.SPEC_OFFSET) + ' = id_' + canvasId + '.getContext("2d");');
...
function appendWebGL(rId, rTxt) {
    ...
    // Initialize view
    console.log('framebuffer = webgl.createFramebuffer();');
    ...
    try {
        switch (rand(2)) {
            ...
            case 1:
                ...
                break;
            default:
                console.log('// Warning: drawWebgl default');
                break;
        }
    } catch (e) {
        console.log('// Error: drawWebgl: ' + e.message);
    }
}
...
function appendNetwork(rId, rTxt) {
    try {
        // Add WebSocket
        console.log('id_' + id.length + ' = new WebSocket("ws://127.0.0.1:8082/echo");');
        ...
        console.log('id_' + xhrId + '.open("' + rType + '", "http://127.0.0.1:8000", ' + rAsyn + ');');
        id[xhrId].open(rType, "http://127.0.0.1:8000", rAsyn);
        console.log('id_' + xhrId + '.send("' + rTxt + '");');
        id[xhrId].send(rTxt);

        console.log('id_' + id.length + ' = ' + 'id_' + xhrId + '.upload;');
        id[id.length] = id[xhrId].upload;
        console.log('id_' + (id.length - 1) + '.id = ' + (id.length - 1) + ';');
        id[id.length - 1].id = id.length - 1;
    } catch (e) {
        console.log('// Error: appendNetwork: ' + e.message);
    }
}

function appendStyle(rId, rTxt) {
    // Add style
    console.log('id_' + id.length + ' = document.createElement("style");');
    ...
    console.log('id_' + (id.length - 1) + '.innerText = "' + cssList + '";');
...
function appendSpecElem() {
    ...
    if(percent(demicm.ADD_WEBGL_PER)) {
        ...
        try {
            ...
            console.log('// WebGL Crash: ' + e.message);
            demicm.WEBGL_PER = 0;
        }
    } else {
        demicm.WEBGL_PER = 0;
...
function constructTag(rTag, tagPropNum, type) {
    console.log('var rElem = document.createElement("' + rTag + '");');
    ...
    if (percent(demicm.REF_TAG_PER)) {
        ...
        if (type == 'body') {
            ...
            console.log('// Warning: constructTag else');
        }
        id[id.length] = null;
    }
...
function constructDOMTree() {
    ...
    console.log('document.body.innerHTML = "' + bodyTagStr.replace(/"/g, '\\"') + '";');
    document.body.innerHTML = bodyTagStr;

    console.log('document.head.innerHTML = "' + headTagStr.replace(/"/g, '\\"') + '";');
    document.head.innerHTML = headTagStr;

    for (var i = 3; i < id.length; i++) {
        console.log('id_' + i + ' = document.getElementById(' + i + ');');
    ...
    try {
        ...
        console.log('// Error: appendSpecElem: ' + e.message);
    }
}
...
function canvas2dMan() {
    ...
    try {
        ...
        console.log('// Error: canvas2dMan: ' + e.message);
    }
}

function webglMan() {
    if (demicm.IS_DEBUG) {
        console.log('[+] webglMan()');
    }
    ...
    try {
        ...
        console.log('// Error: webglMan: ' + e.message);
    }
...
function fireEvent() {
    ...
    try {
        ...
        console.log('var evt = document.createEvent("' + evtName + '");');
        ...
        for (var i = 0; i < evtParams.length; i++) {
            if (evtParams[i] == 'bool') {
                ...
                console.log('// Warning: fireEvent else ' + evtParams[i]);
            }
        ...
        console.log('evt.' + evtFunc + '("' + rEvtType + '",' + logParam + ');');
        eval('evt.' + evtFunc + '("' + rEvtType + '",' + evtParam + ');');

        if (document.activeElement && percent(30)) {
            console.log('document.activeElement.dispatchEvent(evt);');
            document.activeElement.dispatchEvent(evt);
        } else {
            console.log('id_' + rId + '.dispatchEvent(evt);');
            id[rId].dispatchEvent(evt);
        }
    } catch (e) {
        console.log('// Error: fireEvent: ' + e.message);
    }
}
...
function demiStart() {
    ...
    if (demicm.BROWSER == 'IE') {
        ...
        console.log('gc = function() { var arrs = []; for (i = 0; i < 100000; i++) { arrs[i] = new Array(); } return arrs; }');
        gc = function() { 
            var arrs = [];
            for (i = 0; i < 100000; i++) {
                arrs[i] = new Array();
